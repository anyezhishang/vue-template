  ...
  <div>
    ...
    <div class="container container-bird">
      ...
      <div class="container-title">
        ...
        <div class="subtitle">哎呀。看来你拐错弯了。请点击下面按钮返回操作~~~</div>
        <div class="container-error">
          <div>错误原因：</div>
          <div>
            <div class="not-found">访问的页面不存在</div>
            <div>请检查访问的资源链接是否正确</div>
          </div>
        </div>
        <div>
          <button @click="returnHomePage">返回首页</button>
          <button @click="returnPreviousPage">返回上一页</button>
        </div>
      </div>
    </div>
  </div>
